...
class MahasiswaBimbinganController extends Controller
{
    ...
    public function view($id)
    {
        ...
        ->first();
        $mahasiswa = Bimbingan::ta_mahasiswa2()->where('tas.ta_id', $taId->ta_id)->first();
    ...
    public function pembimbingan(Request $request, $ta_id)
    {
        ...
        $bimbLog = BimbinganLog::BimbinganLog($ta_id);

        // Fetch the first mahasiswa data matching the given ta_id
        $mahasiswa = Bimbingan::ta_mahasiswa2()->where('tas.ta_id', $ta_id)->first();
    ...
    public function setujuiSidangAkhir($ta_id)
    {
        ...
        $verif = BimbinganLog::BimbinganLog($ta_id)->where('bimb_status', 1)->count();
        // dd($verif);
