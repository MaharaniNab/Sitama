...
class Bimbingan extends Model
{
    ...
    protected $fillable = [
        'mhs_nim', 'mhs_nama', 'ta_judul', 'tahun_akademik', 'verified'
    ];

    // Relasi many-to-many dengan model Dosen
    public function dosen()
    {
        return $this->belongsToMany(Dosen::class, 'bimbingan_dosen', 'bimbingan_id', 'dosen_nip');
    }
}
